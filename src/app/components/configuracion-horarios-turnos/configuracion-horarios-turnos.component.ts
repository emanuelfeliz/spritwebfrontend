...
@Component({
  selector: 'app-configuracion-horarios-turnos',
  templateUrl: './configuracion-horarios-turnos.component.html'
})
export class ConfiguracionHorariosTurnosComponent implements OnInit {
